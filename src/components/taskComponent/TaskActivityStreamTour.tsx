...
import { taskActivityStreamTourSteps } from "@/lib/taskActivityStreamTourSteps";

interface TaskActivityStreamTourProps {
  onComplete?: () => void;
}

const TaskActivityStreamTour: React.FC<TaskActivityStreamTourProps> = ({ onComplete }) => {
  useEffect(() => {
    const tourSteps = taskActivityStreamTourSteps;
...
export default TaskActivityStreamTour;
