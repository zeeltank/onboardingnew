...
const AddDialog: React.FC<AddDialogProps> = ({ onClose, onSuccess }) => {
  ...
  const fetchInitialData = async () => {
    const res = await fetch(
      `${sessionData.url}/knowledge_library/create?type=API&token=${sessionData.token}&sub_institute_id=${sessionData.subInstituteId}&org_type=${sessionData.orgType}`
    );
  ...
  const generateFormContent = async (knowledgeName: string, description: string) => {
    if (!knowledgeName.trim() || !description.trim()) {
      return alert("Please enter both knowledge name and description first");
    }

    if (!formData.category.trim()) {
      return alert("Please select a Knowledge Category first");
    }

    if (!formData.sub_category.trim()) {
      return alert("Please select a Knowledge Sub Category first");
    }
    ...
    try {
      ...
      setFormData(prev => ({
        ...
        knowledge_maps: aiResponse.knowledge_mapping || prev.knowledge_maps
      }));
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const payload = {
      ...
      type: "API",
      method_field: 'POST',
      related_knowledges: selectedSkills,
    ...
    try {
      const res = await fetch(`${sessionData.url}/knowledge_library`, {
        method: 'POST',
        headers: {
      ...
      <div className="bg-white p-6 rounded-md w-4/5 max-w-5xl shadow-lg relative my-auto"> {/* Added my-auto for vertical centering when content is smaller than screen */}
        ...
        <div className="flex w-full">
          ...
          <div className="w-[90%] bg-gradient-to-r from-violet-100 to-violet-200 p-4 text-center rounded-r-lg">
            <h2 className="text-gray-800 font-bold text-lg">Add New Knowledge</h2>
          ...
          <form className="w-[100%]" onSubmit={handleSubmit}>
            ...
            <div className="grid md:grid-cols-2 md:gap-6">
              <div className="relative z-0 w-full mb-5 group text-left">
                <label htmlFor="category" className="text-left">Knowledge Category{" "}
              ...
              <div className="relative z-0 w-full mb-5 group text-left">
                <label htmlFor="sub_category" className="text-left">Knowledge Sub Category</label><br />
                <select
                  name="sub_category"
            ...
            <div className="grid md:grid-cols-2 md:gap-6">
              <div className="relative z-0 w-full mb-5 group text-left">
                <label htmlFor="knowledge_name" className="text-left">Knowledge Name{" "}
                <span className="mdi mdi-asterisk text-[10px] text-danger"></span></label><br />
                <input
                  type="text"
                  name="knowledge_name"
              ...
              <div className="relative z-0 w-full mb-5 group text-left">
                <label htmlFor="description" className="text-left">Knowledge Description</label><br />
                <div className="flex gap-2">
                  ...
                  <button
                    type="button"
                    onClick={() => generateFormContent(formData.knowledge_name, formData.description)}
            ...
            <div className="grid md:grid-cols-2 md:gap-6">
              <div className="w-full mb-5 group text-left">
                <label htmlFor="related_knowledges" className="text-left">Related Knowledges</label><br />
              ...
              <div className="relative z-0 w-full mb-5 group text-left">
                <label htmlFor="custom_tags" className="text-left">Knowledge Custom Tags</label><br />
                <input
                  type="text"
            ...
            <div className="grid md:grid-cols-2 md:gap-6">
              <div className="relative z-0 opacity-100 w-full mb-5 group text-left">
                <label htmlFor="business_links" className="text-left">Knowledge Business links</label><br />
                <input
                  type="text"
                  name="business_links"
                  className="w-full rounded-lg p-2 border-2 border-[var(--color-blue-100)] h-[38px] bg-[#fff] text-black focus:outline-none focus:border-blue-500" // Changed w-3/3 to w-full
            ...
            <div className="grid md:grid-cols-2 md:gap-6">
              <div className="relative z-0 w-full mb-5 group text-left">
                <label htmlFor="learning_resources" className="text-left">Knowledge Learning Resources</label><br />
                <textarea
              ...
              <div className="relative z-0 w-full mb-5 group text-left">
                <label htmlFor="assesment_method" className="text-left">Knowledge Assesment Method</label><br />
                <textarea
            ...
            <div className="grid md:grid-cols-2 md:gap-6">
              <div className="relative z-0 w-full mb-5 group text-left">
                <label htmlFor="certification_qualifications" className="text-left">Knowledge Certification/Qualifications</label><br />
                <textarea
              ...
              <div className="relative z-0 w-full mb-5 group text-left">
                <label htmlFor="experience_project" className="text-left">Knowledge Experience/Project</label><br />
                <textarea
            ...
            <div className="grid md:grid-cols-2 md:gap-6">
              <div className="relative z-0 w-full mb-5 group text-left">
                <label htmlFor="knowledge_maps" className="text-left">Knowledge Map</label><br />
                <textarea
                  name="knowledge_maps"
                  rows={2}
                  className="w-full block p-2 border-2 border-[var(--color-blue-100)] rounded-lg focus:outline-none focus:border-blue-500 bg-white text-black"
                  placeholder="Enter Knowledge Map..."
                  onChange={handleFormChange}
                  value={formData.knowledge_maps || ''}
                ></textarea>
              </div>
            </div>
