...
export default function NotFound() {
  useEffect(() => {
    // Visor drawing
    const visorCanvas = document.getElementById('visor') as HTMLCanvasElement
    ...
    <html lang="en">
      ...
      <body>
        <style jsx global>{`
          ...
          .astronaut__wrist-left { top: 122px; left: 6.5px; transform: rotate(-15deg); }
          .astronaut__wrist-right { top: 98px; left: 141px; transform: rotate(-10deg); }
          ...
          .astronaut__leg-left { left: 50px; transform: rotate(10deg); }
          .astronaut__leg-right { left: 108px; transform: rotate(-10deg); }
          ...
          .astronaut__foot-left { left: 43px; transform: rotate(10deg); }
          .astronaut__foot-right { left: 111px; transform: rotate(-10deg); }
        `}</style>
        ...
        <div className="error">
          <div className="error__title">coming soon</div>
        ...
        <div className="astronaut">
          ...
          <div className="astronaut__cord">
            <canvas id="cord" width="500" height="500" />
          </div>
